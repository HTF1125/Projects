...
# from app.db.models import Base, TbMeta, TbPxDaily, TbGlossary, NewMeta
# from app.db.common.engine import local_engine, pgsql_engine
# from ..common import Session, Engine, Config
...
#     NewMeta.insert(get_data("new_meta").to_dict("records"))
